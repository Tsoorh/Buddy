...
- [ ] **2. Configuration & Security (`app/core/config.py` & `.env`)**:
...
- [ ] **3. File Management Service (`app/service/file_service.py`)**:
...
- [ ] **4. API Endpoints (`app/api/catch/routes.py` & `controller.py`)**:
